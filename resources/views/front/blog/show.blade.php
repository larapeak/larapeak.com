    ...
    <article class="max-w-3xl mx-auto">
        ...
        <div class="flex px-6 py-4 mt-12 text-blue-500 bg-blue-100 border border-blue-200 rounded">
            <div class="flex items-center">
                ...
                <span>Follow me on twitter to get notified when I post a new blog @<a href="https://www.twitter.com/larapeakdev" target="_BLANK" class="font-semibold underline transition duration-300 hover:text-blue-600">larapeakdev</a></span>
            </div>
        </div>
